...
truth_predict_data['S4_MLP_truth']=inv_truth_squence
truth_predict_data['S4_MLP_predict']=inv_predict_squence
truth_predict_data.to_excel('truth_predict_data_S4.xlsx')

with open('result_dict.json', 'r') as json_file:
    result_dict = json.load(json_file)
result_dict['S4_MLP_mape'] = float(S1_result[0])
result_dict['S4_MLP_mse'] = float(S1_result[1])
result_dict['S4_MLP_mae'] = float(S1_result[2])
# mape,mse,mae

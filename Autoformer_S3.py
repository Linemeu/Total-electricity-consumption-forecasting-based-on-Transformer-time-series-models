...
truth_predict_data['S3_Autoformer_t2v_truth']=inv_truth_squence
truth_predict_data['S3_Autoformer_t2v_predict']=inv_predict_squence
...
# result_dict['S3_Autoformer_mape']=float(S1_result[0])
# result_dict['S3_Autoformer_mse']=float(S1_result[1])
# result_dict['S3_Autoformer_mae']=float(S1_result[2])
# #mape,mse,mae

...
truth_predict_data['S5_SVR_truth']=inv_truth_squence
truth_predict_data['S5_SVR_predict']=inv_predict_squence
truth_predict_data.to_excel('truth_predict_data_S5.xlsx')

with open('result_dict.json', 'r') as json_file:
    result_dict = json.load(json_file)
result_dict['S5_SVR_mape'] = float(S5_result[0])
result_dict['S5_SVR_mse'] = float(S5_result[1])
result_dict['S5_SVR_mae'] = float(S5_result[2])
# mape,mse,mae

...
# import pandas as pd
# try:
#     truth_predict_data=pd.read_excel('E:\用电量预测\\truth_predict_data_S3.xlsx')
# except:
#     print('没找到文件')
#     truth_predict_data=pd.DataFrame()
# truth_predict_data['S3_Informer_t2v_truth']=inv_truth_squence
# truth_predict_data['S3_Informer_t_2v_predict']=inv_predict_squence
...
try:
    ...
    print('没找到文件')
    truth_predict_data=pd.DataFrame()
truth_predict_data['S3_Informer_truth']=inv_truth_squence
truth_predict_data['S3_Informer_predict']=inv_predict_squence
truth_predict_data.to_excel('truth_predict_data_S3.xlsx')
# import json
...
# result_dict['S3_Informer_mape']=float(S1_result[0])
# result_dict['S3_Informer_mse']=float(S1_result[1])
# result_dict['S3_Informer_mae']=float(S1_result[2])
# #mape,mse,mae

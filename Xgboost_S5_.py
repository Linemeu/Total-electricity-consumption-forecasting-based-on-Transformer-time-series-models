...
truth_predict_data['S5_Xgboost_truth']=inv_truth_squence
truth_predict_data['S5_Xgboost_predict']=inv_predict_squence
truth_predict_data.to_excel('.\\truth_predict_data_S5.xlsx')

with open('result_dict.json', 'r') as json_file:
    result_dict = json.load(json_file)
result_dict['S5_Xgboost_mape'] = float(S1_result[0])
result_dict['S5_Xgboost_mse'] = float(S1_result[1])
result_dict['S5_Xgboost_mae'] = float(S1_result[2])
# mape,mse,mae

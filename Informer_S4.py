...
truth_predict_data['S4_Informer_t2v_truth']=inv_truth_squence
truth_predict_data['S4_Informer_t2v_predict']=inv_predict_squence
...
# result_dict['S4_Informer_mape']=float(S1_result[0])
# result_dict['S4_Informer_mse']=float(S1_result[1])
# result_dict['S4_Informer_mae']=float(S1_result[2])
# #mape,mse,mae

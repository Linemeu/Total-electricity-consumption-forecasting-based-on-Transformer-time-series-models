...
truth_predict_data['S2_MLP_truth']=inv_truth_squence
truth_predict_data['S2_MLP_predict']=inv_predict_squence
...
result_dict['S2_MLP_mape'] = float(S1_result[0])
result_dict['S2_MLP_mse'] = float(S1_result[1])
result_dict['S2_MLP_mae'] = float(S1_result[2])
# mape,mse,mae

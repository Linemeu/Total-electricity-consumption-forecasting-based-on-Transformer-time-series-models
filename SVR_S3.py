...
truth_predict_data['S3_SVR_truth']=inv_truth_squence
truth_predict_data['S3_SVR_predict']=inv_predict_squence
...
result_dict['S3_SVR_mape'] = float(S1_result[0])
result_dict['S3_SVR_mse'] = float(S1_result[1])
result_dict['S3_SVR_mae'] = float(S1_result[2])
# mape,mse,mae

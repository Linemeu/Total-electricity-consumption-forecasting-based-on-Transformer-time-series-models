...
truth_predict_data['S5_Autoformer_t2v_truth']=inv_truth_squence
truth_predict_data['S5_Autoformer_t2v_predict']=inv_predict_squence
...
#     print('没找到')
#     result_dict={}
# result_dict['S5_Autoformer_mape']=float(S5_result[0])
# result_dict['S5_Autoformer_mse']=float(S5_result[1])
# result_dict['S5_Autoformer_mae']=float(S5_result[2])
# #mape,mse,mae

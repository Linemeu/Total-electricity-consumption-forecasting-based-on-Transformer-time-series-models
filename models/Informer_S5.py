...
truth_predict_data['S5_Informer_t2v_truth']=inv_truth_squence
truth_predict_data['S5_Informer_t2v_predict']=inv_predict_squence
truth_predict_data.to_excel('E:\用电量预测\\truth_predict_data_S5.xlsx')

# import json
# try:
#     with open('result_dict_no_t2v.json', 'r') as json_file:
# 	    result_dict = json.load(json_file)
# except:
#     print('没找到')
#     result_dict={}
# result_dict['S5_Informer_mape']=float(S1_result[0])
# result_dict['S5_Informer_mse']=float(S1_result[1])
# result_dict['S5_Informer_mae']=float(S1_result[2])
# #mape,mse,mae
# dict_json=json.dumps(result_dict)
# file= open("result_dict_no_t2v.json","w+")
# json.dump(result_dict, file)
# file.close()
# # np.save('S5_Informer',S1_result)
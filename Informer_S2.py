...
# result_dict['S2_Informer_mape']=float(S1_result[0])
# result_dict['S2_Informer_mse']=float(S1_result[1])
# result_dict['S2_Informer_mae']=float(S1_result[2])
# #mape,mse,mae
...
truth_predict_data['S2_Informer_t2v_truth']=inv_truth_squence
truth_predict_data['S2_Informer_t2v_predict']=inv_predict_squence
